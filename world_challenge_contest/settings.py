"""
Django settings for world_challenge_contest project.
...
SECRET_KEY = '(o49zn6+0w=k&6_+0i=9#aa7es7%x_piv3e)8ok!)s1+q@jpas'
...
WSGI_APPLICATION = 'world_challenge_contest.wsgi.application'
